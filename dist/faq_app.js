function FaqApp() {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Header, {
    ...
    onQuote: openQuote
  }), React.createElement("main", null, React.createElement(FqHero, {
    query: query,
    setQuery: setQuery
  }), React.createElement(FqMain, {
    query: query
  }), React.createElement(FqNoAnswer, null), React.createElement(CtaFinal, {
    onQuote: openQuote
...
ReactDOM.createRoot(document.getElementById('root')).render(React.createElement(FaqApp, null));