function ContactoApp() {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Header, {
    ...
    onQuote: openQuote
  }), React.createElement("main", null, React.createElement(CtHero, null), React.createElement(CtMain, null), React.createElement(CtMap, null)), React.createElement(Footer, null), React.createElement("a", {
    href: WA_URL,
    target: "_blank",
    rel: "noopener",
    className: "wa-float",
...
ReactDOM.createRoot(document.getElementById('root')).render(React.createElement(ContactoApp, null));