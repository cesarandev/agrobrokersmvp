function SagrilaftApp() {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Header, {
    ...
    onQuote: openQuote
  }), React.createElement("main", null, React.createElement(SgHero, null), React.createElement(SgAbout, null), React.createElement(SgPrincipios, null), React.createElement(SgChannel, null), React.createElement(SgDoc, null), React.createElement(CtaFinal, {
    onQuote: openQuote
...
ReactDOM.createRoot(document.getElementById('root')).render(React.createElement(SagrilaftApp, null));