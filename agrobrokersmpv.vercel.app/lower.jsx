...
function Services() {
  const cards = [
    { icon: 'flask', title: 'Análisis de suelo y foliar', text: 'Diagnóstico técnico del suelo y el follaje como base científica para el plan de fertilización.', href: 'Servicios.html#complementarios' },
    { icon: 'userCheck', title: 'Asesoría agronómica', text: 'Acompañamiento técnico-comercial en campo con profesionales especializados en cada cultivo.', href: 'Servicios.html#complementarios' },
    { icon: 'clipboard', title: 'Plan de fertilización', text: 'Plan personalizado de nutrición por finca: objetivos de rendimiento, dosis y cronograma de aplicación.', href: 'Servicios.html#complementarios' },
  ];
  return (
    <section className="services section-pad" id="servicios">
      <div className="wrap">
        <div className="services__head">
          ...
          <p className="section-sub">Más allá del fertilizante: tecnología y conocimiento técnico al servicio de su cultivo.</p>
        </div>
        <div className="svc-grid">
          <Reveal className="svc-card feature" as="a" href="Servicios.html#agropilot">
            <div className="svc-feature__art" />
            <div className="svc-card__icon"><I.drone /></div>
            <span className="svc-feature__tag">Servicio estrella</span>
            <h3>AgroPilot</h3>
            <p>Dron agrícola: espectrometría, fumigación y aplicación precisa de insumos en grandes extensiones.</p>
            <span className="svc-card__cta">Conocer más <I.arrow size={14} /></span>
          </Reveal>
          {cards.map((c, i) => {
            const Ic = I[c.icon];
            return (
              <Reveal key={i} className="svc-card" as="a" href={c.href} delay={(i + 1) * 90}>
                <div className="svc-card__icon"><Ic /></div>
                <h3>{c.title}</h3>
                <p>{c.text}</p>
                <span className="svc-card__cta">Conocer más <I.arrow size={14} /></span>
              </Reveal>
        ...
        <div className="services__foot">
          <a href="Servicios.html" className="btn btn-outline">Ver todos los servicios <I.arrow size={16} /></a>
        </div>
      </div>
    </section>
  );
    ...
    <section className="blog section-pad" id="blog">
      <div className="wrap">
        <div className="blog__head">
          ...
          <a href="Blog.html" className="btn btn-outline">Ver todos los artículos</a>
        </div>
...
const TESTIMONIALS = [
  ...
  { text: 'La tecnología CRF de Control Release nos permitió reducir el número de aplicaciones manteniendo la nutrición constante. Un ahorro real en mano de obra.', name: 'Jefe de Campo', org: 'Agrícola San Isidro', crop: 'Aguacate Hass · Antioquia', initials: 'SI' },
  ...
  return (
    <section className="cta-final section-pad" id="contacto">
      <div className="wrap">
        ...
        <a className="cta-final__link" href="Contacto.html">Ver todas las formas de contacto <I.arrow size={15} /></a>
        <div className="cta-final__social">
...
function Footer() {
  const navLinks = ['Inicio','Nosotros','Productos','Servicios','Blog','FAQ','SAGRILAFT','Contacto'];
  const legal = [['Política de Privacidad', 'SAGRILAFT.html'], ['Tratamiento de Datos (Ley 1581/12)', 'SAGRILAFT.html'], ['SAGRILAFT', 'SAGRILAFT.html']];
  return (
    <footer className="footer">
      <div className="wrap footer__grid">
        <div className="footer__col footer__brand">
          <img src="assets/logo-white.png" alt="AgroBrokers" />
...
Object.assign(window, { Services, Blog, Testimonials, CtaFinal, Footer });
