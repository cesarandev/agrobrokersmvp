    ...
    <section className="why section-pad" id="nosotros">
      <div className="wrap">
        ...
        <div className="why__foot">
          <a href="/nosotros" className="btn btn-outline">Saber más sobre nosotros <I.arrow size={16} /></a>
        </div>
      </div>
    </section>);
...
{ name: 'Chronos (CRF)', tag: 'Liberación controlada: el nutriente disponible en el momento exacto', color: 'var(--fam-chronos)', badge: 'A la medida', prod: 'assets/prod-chronos.png' },
...
{ name: 'NovaMix / NextGen', tag: 'Fertilizantes simples de nueva generación y alta pureza', color: 'var(--fam-novamix)', badge: 'NovaMix', prod: null },
  ...
  return (
    <article className="fam-card" onClick={onQuote}>
      <div className="fam-card__img">
        ...
        {fam.prod ?
        <img className="fam-card__prod" src={RES(fam.prod)} alt={fam.name} loading="lazy" /> :
        <React.Fragment>
    ...
    <section className="families section-pad" id="productos">
      <div className="wrap">
        <div className="families__head">
          ...
          <p className="section-sub">Ocho líneas especializadas diseñadas para cubrir cada necesidad de nutrición de su cultivo.</p>
        </div>
...
function Stats() {
  ...
  { n: 30, pre: '+', label: 'Registros ICA activos' }];
