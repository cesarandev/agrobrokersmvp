...
/* Asset resolver — uses inlined blob URL (window.__resources keyed by path) when bundled
   standalone, otherwise falls back to the normal relative path. Works on every page. */
function RES(path) {
  if (!path) return path;
...
Object.assign(window, { useCountUp, Reveal, Accordion, RES });
